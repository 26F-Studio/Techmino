...
return{
    ...
    {"Ascension",
        "asc ASC",
        "game",
        "ブラウザーゲーム | シングルプレイ/マルチプレイ\n省略として「ASC」. 独自の回転システム (これの名前も「ASC」) を採用しており更には沢山のシングルプレイ用のモードを兼ね揃えています。12月15日2021年現在、バトルモードは現在の所、Beta開発中であります。The Stack mode in this game was also inspired by Ascension. ",
