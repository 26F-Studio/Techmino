...
return{
    ...
    modes={
        ...
        ['rhythm_e']=       {"Irama",             "MUDAH",         "200-baris maraton irama dengan tempo rendah"},
        ['rhythm_h']=       {"Irama",             "SULIT",         "200-baris maraton irama dengan tempo sedang"},
        ['rhythm_u']=       {"Irama",             "TERAKHIR",      "200-baris maraton irama dengan tempo tinggi"},
