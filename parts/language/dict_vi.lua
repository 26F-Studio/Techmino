...
Dưới đây là một số quy tắc chung, nhưng chúng không phải là quy tắc bắt buộc
    ...
    {"Deepdrop (Rơi sâu)",
        "shenjiang",
        "term",
        "*Chỉ có trên Techmino*\n\nMột chức năng cho phép cho phép gạch có thể teleport xuyên đất để xuống phía dưới. Khi gạch đụng vào đáy hoặc một gạch khác, nhấn phím Rơi nhẹ để kích hoạt Deepdrop. Giả sử có một cái hố phù hợp với hình dạng của gạch. Trong trường hợp đó, gạch sẽ được teleport vào hố đó.\nCơ chế này đặc biệt hữu ích cho AI vì nó cho phép AI bỏ qua sự khác biệt giữa các hệ thống xoay khác nhau.",
    },
    {"Misdrop",
        "md misdrop",
        "term",
    ...
    {"Mishold",
        "mh mishold",
        "term",
        "Vô tình nhấn nhầm nút Hold. Việc này có thể dẫn đến việc dùng một viên gạch không mong muốn, và có thể bỏ lỡ cơ hội có thể làm PC.",
    },
    {"sub",
        "sub",
        "term",
...
Trong hầu hết các trò chơi, tỷ lệ phản công rác thường là 1:1, một lần tấn công đánh phản lại một lần nhận rác.
    ...
    {"Side 1-wide",
        ...
        "term",
        "Hay còn gọi là Side well Tetris.\nĐây là cách chơi xếp gạch truyền thống, bạn sẽ phải xây một cái hố sâu rộng 1 ô (duy nhất) ở một mặt bên của bảng. Dễ thực hiện trong Tetris hiện đại và có thể làm tấn công... nửa vời [*]. Nhưng setup này hiếm khi được sử dụng trong những trận đấu hạng cao do hiệu quả của Tetris thấp hơn so với T-Spin.\n\n[*] Sea: cái này mình không có viết vào, Zictionary nó viết như vậy á.",
    },
    {"Side 2-wide",
        "s2w side2wide",
        "term",
