...
Khi đọc, bạn hãy lưu ý là: từ "lỗ" với từ "hố" được sử dụng như từ "hole"
Trong khi đó từ "giếng" được sử dụng cho từ "well"
...
Chúng tôi có vài lời khuyên dành cho những người mới chơi xếp gạch:
    ...
    3 kỹ năng cơ bản:
        ...
        2. Nhớ các thao tác để di chuyển gạch đến vị trí mong muốn.
...
Sau đây là vài lời khuyên của chúng tôi để cải thiện kỹ năng chơi của bạn. Cảm thấy bị kẹt giữa chừng? Bạn có thể nghỉ ngơi và dành nhiều thời gian hơn để chơi những chế độ bạn thích. Chơi vui vẻ!
...
B. Efficiency & Speed (Hiệu quả & Tốc độ)
        B1. Đừng có dựa bóng gạch quá nhiều! Thay vào đó: Trước mỗi lần đặt gạch, hãy suy nghĩ xem bạn sẽ đặt gạch ở đâu? Bấm những phím nào để gạch tới chỗ đó và đứng đúng tư thế?
...
Sau khi xong nhóm C, hãy luyện tập tiếp nhóm A, đây là kỹ năng RẤT quan trọng trong bất kỳ game xếp gạch nào. Sau khi làm chủ được kỹ năng đọc NEXT thì bạn dễ dàng thành thạo các thứ khác.
    ...
    {"Học làm T-spin",
        ...
        "help",
        [[
T-spin là một kỹ năng khá khó, không tài nào thành thạo nổi nếu chỉ có nhìn vào địa hình nơi làm T-spin.
Trước khi học T-spin, hãy: làm chủ được kỹ năng đọc NEXT và hiểu rõ về xếp gạch. 
Khuyến nghị: Nên làm chủ được các kỹ năng cơ bản.
...
Dưới đây là các yếu tố chính:
    ...
    5. Có hệ thống trì hoãn khóa gạch thích hợp.
    6. Có cơ chế top-out thích hợp
    7. Có NEXT - hiện từ 3-6 gạch sắp rơi (vẫn chấp nhận trường hợp chỉ hiện 1 gạch), những gạch này xuất hiện ở tư thế khi chúng vừa mới xuất hiện trong bảng
    8. Cho phép Hold
    9. Nếu có spawn delay hoặc clear delay, game thường sẽ có hệ thống IRS và IHS. Techmino còn có cả hệ thống IMS nữa (tìm trong Zictionary để biết thêm)
...
Ở các trò xếp gạch hiện đại, mỗi gạch có thể xoay dựa trên một tâm xoay cố định (vài game có thể không có tâm xoay cố định). Nếu gạch sau khi xoay đè lên gạch khác / ra ngoài bảng, hệ thống sẽ thử "wall-kicking" (đá tường) (đẩy gạch sang các vị trí xung quanh). Tuy nhiên, nếu khoảng cách quá lớn thì hệ thống xoay không thể đá gạch được
...
Đá tường cho phép gạch có thể đến những lỗ có hình dạng nào đó mà bình thường không thể tiếp cận được. Các vị trí mà gạch hệ thống xoay có thể thử được chứa trong một bảng gọi là "wall-kick table" (bảng (các vị trí) đá tường).
    ...
    {"ASC",
        "nhom05b ascension",
        "term",
        "Hệ thống xoay được dùng trong Ascension (tên viết tắt cũng là ASC) — một bản clone của Tetris. Tất cả các gạch đều sử dụng chung một bảng đá tường (một dành cho xoay phải, một dành cho xoay trái), và vùng đá nằm trong khoảng cách ± 2 ô ở cả hai trục.",
    },
    {"ASC+",
        "nhom05b ascension ascplus",
        "term",
        "Một phiên bản chỉnh sửa của ASC trong Techmino, hỗ trợ đá tường khi xoay 180°.",
    },
    {"BRS",
...
1. Giữ một nút di chuyển (Trái / Phải  / Thả nhẹ)
2. Gạch hiện tại phải chạm các miếng gạch khác ở hướng đang được giữ ở bước 1
...
So với XRS, BiRS dễ nhớ hơn vì chỉ dùng một bảng đá tường; nhưng vẫn giữ được khả năng vượt địa hình của SRS.
    ...
    {"C2RS",
        ...
        "term",
        "Cultris II rotation system | Hệ thống xoay Cultris II\n\nMột hệ thống xoay ở trong Cultris II — một bản clone của Tetris.\nToàn bộ gạch và cả hướng xoay đều sử dụng chung một bảng đá tường (trái, phải, dưới, dưới trái, dưới phải, trái 2, phải 2), với ưu tiên về phía bên trái so với bên phải.\n\nTrong Techmino có một bản chỉnh sửa của hệ thống này, đó là C2sym. C2sym sẽ ưu tiên hướng theo hình dạng của gạch",
    },
    {"C2sym",
        "nhom05b cultris2",
        "term",
        "Một bản chỉnh sửa của C2RS. Hệ thống sẽ ưu tiên hướng Trái / Phải tùy vào hình dạng của các viên gạch khác nhau.",
    },
    {"DRS",
    ...
    {"XRS",
        "nhom05b xrs",
        "term",
        "X rotation system | Hệ thống xoay X, một hệ thống xoay trong T-ex.\n\nỞ trong các hệ thống khác, bảng đá tường là cố định, nên gạch chỉ có thể bị đá ra một hướng (và hướng đó có thể không phải là hướng mà người chơi muốn). XRS giải quyết vấn đề nan giải này bằng cách cho phép người chơi giữ phím di chuyển (Trái / Phải / Thả nhẹ) để hệ thống ưu tiên theo hướng đó. Điều đó làm cho việc điều khiển hướng đi của gạch sau khi đá tường của người chơi dễ dàng hơn.",
    },
    {">C|Hệ thg đ.khiển",
        "nhom05c",
        "name",
    ...
    {"IHS",
        ...
        "term",
        "Initial Hold System\nCho phép bạn giữ phím Hold trong khoảng thời gian spawn delay để thay gạch sắp tới bằng gạch trong HOLD (và cất / giữ gạch kia đi). Có thể giúp bạn thoát chết trong một vài tình huống.",
    },
    {"IMS",
...
Trong hầu hết các game, tỷ lệ phản công rác thường là 1:1.
        ]],
    },
    {"Combo",
        "nhom05g ren combo",
...
Đa số opener sẽ tận dụng Kiểu xáo Túi 7 gạch và khai thác một điều thực tế là kiểu xáo gạch này luôn cung cấp một cho mỗi loại gạch sau mỗi 7 gạch khác nhau. Yếu tố này giúp có thể có các setup tin cậy hơn.
    ...
    {"Fin, Neo, Iso",
        "nhom12c fin neo iso",
        "pattern",
        "Tên của 3 kiểu T-spin sử dụng bảng đá tường đặc biệt của gạch T. Các game khác nhau có cách phản công khác nhau với loại này: có game tính là Mini-spin, nhưng cũng có game không tính luôn =))).\n\nTrên thực tế chúng không được sử dụng nhiều vì game thường sẽ nerf loại T-spin này; hơn nữa setup của ba loại này khá là phức tạp."
    },
    {"PC liên tiếp (1 / 3)",
        "nhom12c pcloop",
        "pattern",
