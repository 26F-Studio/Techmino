...
NHÓM 07: MỘT VÀI CƠ CHẾ VÀ CHẾ ĐỘ CỦA MỘT SỐ GAME
    ...
    {"Chinese Tetris Wiki",
        "china tetris wiki",
        "help",
        "Tạm dịch: Tetris Wiki bằng tiếng Trung.\nMột wiki được viết bởi những người đam mê xếp gạch từ các nhóm và chi nhánh của Chinese Tetris Research Community (Cộng đồng nghiên cứu Tetris Trung Quốc). Hiện tại đa số các trang được tham khảo và dịch từ wiki Hard Drop và Tetris.wiki. Liên kết sẽ dẫn bạn tới wiki viết bằng tiếng Trung giản thể.",
        "http://tetriswiki.cn",
    },
    {"Wiki Hard Drop",
