...
Dưới đây là một số quy tắc chung, nhưng chúng không phải là quy tắc bắt buộc
    ...
    {"Swap",
        "hold",
        "term",
        "Tương tự như *Hold*, nhưng sẽ lấy gạch tiếp theo từ Next; gạhc đang rơi hiện tại sẽ đứng cuối hàng. You can also only perform this once per piece in most cases.",
    },
    {"Deepdrop (Rơi sâu)",
        "shenjiang",
        "term",
    ...
    {"Donation",
        "donate",
        "term",
        "Một phương pháp “cắm” vào hố có thể làm Tetris để làm T-spin. Sau khi làm T-Spin, hố đó được mở ra để làm Tetris hoặc đào xuống.\n-- Harddrop wiki",
    },
    {"‘Debt’",
        "qianzhai debt owe",
        "term",
...
Techmino does not check for locking out and topping out.
    ...
    {"Vùng biến mất",
        ...
        "term",
        "Tên tiếng Anh là “Vanish Zone”. Thường dùng để nhắc tới những hàng có độ cao từ 40 ô và cao hơn. Cái này chỉ có thể phát hiện ra bằng cách sử dụng C4W và đống hàng rác. Thông thường, nếu cột cao nhất trong bảng đụng vào vùng biến mất.\nTuy nhiên, có một số game có những hành vi khác nhau trong game. Một số game sẽ bị lỗi vì trò chơi có thể bị sập khi có gạch đi vào vùng biến mất (ví dụ như Tetris Online). Riêng ở một số game thì game sẽ có hành động lạ (bạn có thể tham khảo video này, hãy nhấn vào biểu tượng quả địa cầu để mở video).\n\nThông tin thêm: Jstris không có vùng đệm, chỉ có vùng biến mất được đặt ở hàng thứ 22.",
...
“G” là đơn vị thường có số khá lớn. Tốc độ của Level 1 trong chế độ Marathon thường là 1/60G (1 ô/giây), và ở Level 13 thường là 1G. Tốc độ cao nhất trong các game Tetris hiện đại là 20G. Ý nghĩa thật sự của 20G là “Tốc độ rơi vô cực” (“Infinite falling speed”), và kể cả có chỉnh bảng cao hơn 20 hàng, chế độ 20G sẽ ép gạch phải xuất hiện ở dưới đáy bảng. Bạn có thể tìm hiểu về 20G ở mục “20G”
...
Đa số opener sẽ tận dụng Kiểu xáo Túi 7 gạch và khai thác một điều thực tế là kiểu xáo gạch này luôn cung cấp một cho mỗi loại gạch sau mỗi 7 gạch khác nhau. Yếu tố dự đoán này giúp có thể có các setup tin cậy hơn.
    ...
    {"Albatross",
        "albatross",
        "setup",
        "Một opener nhìn đẹp mắt, nhịp độ nhanh với TSD - TST - TSD - All Clear, hardly wasting any T pieces.\nĐể có thêm thông tin, xin vui lòng tra wiki Hard Drop. Hãy nhấn vào biểu tượng quả địa cầu để mở link.",
