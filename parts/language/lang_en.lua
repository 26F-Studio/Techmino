return{
	...
	getTip={refuseCopy=true,
		...
		"Handling potion: less MD II (1:30)",
		...
		"There are three hidden modes in game",
		"Total 18 pentominoes",
		"Total 7 tetrominoes",
		...
		{COLOR.G,"Hotkey: Alt+F4=Close current window"},
		{COLOR.G,"Hotkey: Alt+Tab=Switch window"},
		{COLOR.G,"Hotkey: backspace=Previous directory"},
		{COLOR.G,"Hotkey: Ctrl+A=Select all"},
		{COLOR.G,"Hotkey: Ctrl+D=Duplicate"},
		{COLOR.G,"Hotkey: Ctrl+F=Find"},
		{COLOR.G,"Hotkey: Ctrl+Wheel=Zoom"},
		{COLOR.G,"Hotkey: shift+del=Confirm deleting file"},
