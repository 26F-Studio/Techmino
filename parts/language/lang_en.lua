...
return {
    ...
    spin="-spin ",
    spinNC="-spin",
    clear={"Single","Double","Triple","Quad","Pentacrash","Hexacrash","Heptacrash","Octacrash","Nonacrash","Decacrash","Undecacrash","Dodecacrash","Tridecacrash","Tetradecacrash","Pentadecacrash","Hexadecacrash","Heptadecacrash","Octadecacrash","Nonadecacrash","Ultracrash","Impossicrash"},
    cleared="$1 lines",
    ...
    errorMsg="TeBlocks ran into a problem and needs to restart.\nYou can send the error log to the developers.",
    ...
    aboutTexts={
        "A block stacking game based on Techmino Upstream",
        "reimagined and improved with a brand new",
        "multiplayer infrastructure rebased from existing networking",
        "",
        "Powered by LÖVE",
        ...
        "Teblocks only asks for permission to vibrate and to connect to the Internet.",
        "",
    ...
    staff={
        "Forked, Developed & Designed By",
        "AndriusOnTwitch",
        "",
        "Online Infrastructure",
        "AndriusOnTwitch",
        "Contact: andriuslive09@gmail.com",
        "",
        "Music & Sound Design",
        "AndriusOnTwitch",
        "",
        "Music & SFX Made Using",
        "Vital",
        "FL Studio 25",
        "",
        "[POWERED BY LÖVE]",
        ...
        "――――――――――――――――――――",
        "",
        "TeBlocks is built on TECHMINO",
        "originally created by 26F Studio",
        "",
        "ORIGINALLY BY MrZ",
        "Email: 1046101471@qq.com",
        "",
        "Original Programming, Development & Design",
        "MrZ",
        "",
        "Original Music Made Using",
        "BeepBox",
        "FL Studio",
        "FL Mobile",
        "Logic Pro X",
        "",
        "Original Programming Contributors",
        "MrZ",
        "ParticleG",
        "Gompyn",
        "Trebor",
        ...
        "(user670)",
        "",
        "Original GitHub CI, Packaging & Backend",
        "ParticleG",
        "Trebor",
        "LawrenceLiu",
        "Gompyn",
        ...
        "(Hailey)",
        "",
        "Original Sound Effects & Voice Packs",
        "Miya",
        "Xiaoya",
        "Mono",
        "Flore",
        ...
        "Trebor",
        "",
        "Original Translations & Localizations",
        "User670",
        "MattMayuga",
        "Mizu",
        "Mr.Faq",
        ...
        "Tourahi Anime",
        "PopUpWaffles",
        "[All other original test staff]",
        "…And You!",
        "",
        "――――――――――――――――――――",
        "",
        "Techmino & 26F Studio are trademarks of 26F Studio.",
        "TeBlocks is an independent fork, licensed under LGPL-3.0.",
        "\"Tetris\" is a registered trademark of The Tetris Holding, LLC,",
        "licensed to The Tetris Company, Inc.",
        "TeBlocks is not affiliated with Tetris Holding, LLC",
        "or The Tetris Company, Inc. in any way.",
    },
    used=[[
    Tools used:
        FL Studio 25 (For newer SFXes and BGMs)
    Libs used:
        Cold_Clear [MinusKelvin] + Cold Clear Wrapper [26F Studios]
        json.lua [rxi]
...
C. Gamepad
    ...
    getTip={refuseCopy=true,
        ...
        "40-line Sprint 1kf WR: 13.298s by fortissim2",
        "6 next 1 hold!",
        "6 next 6 hold?!",
        ...
        {C.C,"Also try Orzmic!"},
        {C.C,"Also try osu! cuz i play the game :P (IGN : ItzNeon)"},
