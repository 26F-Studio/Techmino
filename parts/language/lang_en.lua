...
return{
    loadText={
        ...
        finish="Press any key to begin",
    },
    sureQuit="Press again to exit the game",
    newDay="A new day, a new beginning!",
    playedLong="You have been playing for a long time. Take a break!",
    playedTooMuch="You have been playing for far too long! Techmino is fun, but remember to take some breaks!",

    atkModeName={"Random","Badges","K.O.s","Attackers"},
    royale_remain="$1 Players Remains",
    powerUp={[0]="+000%","+025%","+050%","+075%","+100%"},
    cmb={nil,"1 Combo","2 Combos","3 Combos","4 Combos","5 Combos","6 Combos","7 Combos","8 Combos","9 Combos","10 Combos!","11 Combos!","12 Combos!","13 Combos!","14 Combos!!","15 Combos!!","16 Combos!!","17 Combos!!!","18 Combos!!!","19 Combos!!!","MEGACOMBO"},
    spin="-spin",
    ...
    ai_fixed="AI incompatible with fixed sequences.",
    ai_prebag="AI incompatible with custom sequences which have non-tetromino.",
    ai_mission="AI incompatible with custom missions.",
    ...
    createRoomSuccessed="Room created successfully!",
    started="Playing",
    ...
    aboutTexts={
        "This is just an *ordinary* block stacker. That’s it.",
