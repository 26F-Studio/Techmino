return{
	...
	playedTooMuch="[Anti-addiction] You've been playing too much today! You can't play right now.",
	...
	switchSpawnSFX="Turn spawn SFX on to play",
	ranks={"D","C","B","A","S"},

	needRestart="Retry the game to apply\nyour new settings.",
	...
	versionIsNew="You are currently on the latest version.",
	versionIsOld="Version $1 is available!",
	...
	modInstruction="Choose some mods (modifiers) to be used!\nMods will modify the game in different ways\n(and possibly break the game in weird ways).\nSome mods will cause your game to be unranked.",
	modInfo={
		next="Next\nOverrides the Next queue length.",
		hold="Hold\nOverrides the Hold queue length.",
		hideNext="Hidden Next\nHides a few next pieces.",
		infHold="Infinite Hold\nWhen enabled, you can hold pieces as many times as you want.",
		hideBlock="Hide Current Piece:\nMakes the current piece invisible.",
		hideGhost="Hide Ghost\nEnable this to remove the ghost piece.",
		hidden="Hide Blocks\nPieces fade out after being locked.",
		flipBoard="Flip Field\nUse it to flip or rotate the field.",
		dropDelay="Fall Speed\nOverrides the speed at which pieces fall (unit: frames/block).",
		lockDelay="Lock Delay\nOverrides a piece's lock delay (unit: frames).",
		waitDelay="Spawn Delay\nOverrides spawn delay (unit: frames).",
		fallDelay="Line Delay\nOverrides line delay (unit: frames).",
		life="Life\nChanges the number of lives players begin with.",
		forceB2B="B2B Only\nWhen the B2B gauge drops below the startup line, the game ends.",
		forceFinesse="0 Finesse Only\nWhen doing finesse faults, the game is over.",
		tele="Teleport\nForces 0 DAS and 0 ARR movement.",
		noRotation="No Rotation\nDisables rotation buttons.",
		noMove="No Movement\nDisables left and right movement buttons.",
		customSeq="Randomizer\nOverrides the randomizer for the game.",
		pushSpeed="Garbage Speed\nOverrides the speed at which garbage lines rise. (unit: blocks/frame)",
		boneBlock="Bone Blocks\nPlay with bone blocks.",
	},
	acts={
	...
	getTip={refuseCopy=true,
		...
		"Got any suggestions? Feel free to post them in our Discord!",
		"Headphones are recommended for better experiences.",
		"Hello world!",
		"if a==true",
		...
		"M@STER PEACE!!",
		"M@STERPIECE!!",
		"Music too distracting? You can turn it off in the settings menu.",
		"O-Spin Triple!",
		"OHHHHHHHHHHHHHH",
		...
		"THE TECHMINO MOVIE　お楽しみパズルの向こう側へ！",
		"THE TECHMINO MOVIE: To the Other Side of the Fun Puzzle!",
		...
		"The songs in this game are made with Beepbox.",
		"Try using two rotate buttons. All three is better.",
		"Using the Initial [insert action] System can save you from trouble.",
		"Warning: Programmer Art",
		"What about 20 PCs?",
		"What about 23 PCs in 100 lines?",
		"What about 26 TSDs?",
		"while(false)",
		"Winner does not use the emulator and never clone.",
		...
		{COLOR.fire,"Also try Tetra Legends"},
		{COLOR.grape,"T-Spin!"},
		{COLOR.grey,"暫定段位:9"},
		{COLOR.grey,"REGRET!!"},
		...
		{COLOR.W,"What is an ",COLOR.lC,"X-Spin",COLOR.W,"?"},
		{COLOR.Y,"暫定段位:GM"},
		{COLOR.Y,"暫定段位:M"},
		{COLOR.Y,"暫定段位:MK"},
		{COLOR.Y,"暫定段位:MM"},
