...
return {
    ...
    modes={
        ...
        ['dig_eff_10l']=    {"堀り",               "EFFICIENCY 10L", "最小のミノ数で10line掘れ!"},
        ['dig_eff_40l']=    {"堀り",               "EFFICIENCY 40L", "最小のミノ数で40line掘れ!"},
        ['dig_eff_100l']=   {"堀り",               "EFFICIENCY 100L","最小のミノ数で100line掘れ!"},
        ['dig_eff_400l']=   {"堀り",               "EFFICIENCY 400L","最小のミノ数で400line掘れ!"},
        ['dig_quad_10l']=   {"堀り",               "TECHRASH 10L",   "techrashだけで10line下穴を掘れ!"},
