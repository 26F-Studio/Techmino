...
return{
    ...
    royale_remain="剩余1美元球员",
    powerUp={[0]="+000%","+025%","+050%","+075%","+100%"},
    cmb={nil,"1连击","2连击","3连击","4连击","5连击","6连击","7连击","8连击","9连击","10连击!","11连击!","12连击!","13连击!","14连击!","15连击!","16连击!","17连击!","18连击!","19连击!","中巴"},
    spin="-旋转",
    clear={"单身","双重的","三倍的","技术崩溃","五角大楼","六面体碰撞"},
    ...
    modes={
        ...
        ['dig_1000l']=     {"挖掘",            "1000升",      "挖1000条垃圾线"},
        ['drought_n']=     {"干旱",            "100升",       "没有工装"},
        ['drought_l']=     {"干旱+",           "100升",       "搞什么呀"},
        ['stack_e']=       {"堆栈",             "容易的",       "打包!"},
        ['stack_h']=       {"堆栈",             "硬的",        "打包!"},
        ['stack_u']=       {"堆栈",             "终极的",       "打包!"},
        ['marathon_n']=    {"马拉松赛跑",         "正常的",       "200线加速马拉松"},
        ...
        ['solo_l']=        {"战争",             "疯子",        "打败AI!"},
        ['solo_u']=        {"战争",             "终极的",       "打败AI!"},
        ['techmino49_e']=  {"技术49",           "容易的",       "49人战斗\n最后一个站着的人获胜"},
        ['techmino49_h']=  {"技术49",           "硬的",        "49人战斗\n最后一个站着的人获胜"},
        ['techmino49_u']=  {"技术49",           "终极的",       "49人战斗\n最后一个站着的人获胜"},
        ['techmino99_e']=  {"科技99",           "容易的",       "99人战斗\n最后一个站着的人获胜"},
        ['techmino99_h']=  {"科技99",           "硬的",        "99人战斗\n最后一个站着的人获胜"},
        ['techmino99_u']=  {"科技99",           "终极的",       "99人战斗\n最后一个站着的人获胜"},
        ['round_e']=       {"回合制",            "容易的",      "轮流玩AI!"},
        ['round_n']=       {"回合制",            "正常的",      "轮流玩AI!"},
        ['round_h']=       {"回合制",            "硬的",        "轮流玩AI!"},
        ['round_l']=       {"回合制",            "疯子",        "轮流玩AI!"},
        ['round_u']=       {"回合制",            "终极的",       "轮流玩AI!"},
        ['master_n']=      {"主人",             "正常的",       "适合20G初学者"},
        ['master_h']=      {"主人",             "硬的",        "20克的职业选手"},
        ['master_m']=      {"主人",             "M21",        "20克大师赛"},
        ['master_final']=  {"主人",             "最终的",       "20G及以上"},
        ['master_ph']=     {"主人",             "幻觉",        "???"},
        ['master_ex']=     {"大师",             "额外的",       "比瞬间还短的永恒"},
        ['rhythm_e']=      {"节奏",            "容易的",        "200线低节奏马拉松"},
        ['rhythm_h']=      {"节奏",            "硬的",         "200线中等节奏马拉松"},
        ['rhythm_u']=      {"节奏",            "终极的",        "200线高节奏马拉松"},
        ['blind_e']=       {"看不见的",         "一半",         "对于新手来说"},
        ['blind_n']=       {"看不见的",         "全部的",        "对于中间产品"},
        ['blind_h']=       {"看不见的",         "突然的",        "对于有经验的人"},
        ['blind_l']=       {"看不见的",         "突然的+",       "对于专业人士"},
        ['blind_u']=       {"看不见的",         "?",           "你准备好了吗?"},
        ['blind_wtf']=     {"看不见的",         "世界跆拳道联盟",   "你还没准备好"},
        ['classic_h']=     {"经典",           "硬的",          "80年代的中速娱乐"},
        ['classic_l']=     {"经典",           "疯子",          "80年代的高速娱乐"},
        ['classic_u']=     {"经典",           "终极的",         "80年代的高速娱乐"},
        ['survivor_e']=    {"幸存者",          "容易的",        "你能活多久?"},
        ['survivor_n']=    {"幸存者",          "正常的",        "你能活多久?"},
        ['survivor_h']=    {"幸存者",          "硬的",          "你能活多久?"},
        ['survivor_l']=    {"幸存者",          "疯子",          "你能活多久?"},
        ['survivor_u']=    {"幸存者",          "终极的",         "你能活多久?"},
        ['attacker_h']=    {"攻击者",          "硬的",          "练习你的进攻技巧!"},
        ['attacker_u']=    {"攻击者",          "终极的",         "练习你的进攻技巧!"},
        ['defender_n']=    {"防守者",          "正常的",         "练习你的防守技巧!"},
        ['defender_l']=    {"防守者",          "疯子",          "练习你的防守技巧!"},
        ['dig_h']=         {"司钻",           "硬的",          "挖掘练习!"},
        ['dig_u']=         {"司钻",           "终极的",         "挖掘练习!"},
        ['bigbang']=       {"大爆炸",          "容易的",         "所有旋转教程\n[在建]"},
        ['c4wtrain_n']=    {"C4W训练",         "正常的",        "无限组合"},
        ['c4wtrain_l']=    {"C4W训练",         "疯子",         "无限组合"},
        ['pctrain_n']=     {"电脑培训",         "正常的",        "完美清晰的实践"},
        ['pctrain_l']=     {"电脑培训",         "疯子",         "更难的完美清晰的练习"},
        ['pc_n']=          {"电脑挑战",         "正常的",        "让电脑在100线以内!"},
        ['pc_h']=          {"电脑挑战",         "硬的",         "让电脑在100线以内!"},
        ['pc_l']=          {"电脑挑战",         "疯子",         "让电脑在100线以内!"},
        ['pc_inf']=        {"无尽个人电脑挑战",    "",            "尽可能多地获取个人电脑"},
        ['tech_n']=        {"技术人员",         "正常的",        "请尝试保持\n向后链接!"},
        ['tech_n_plus']=   {"技术人员",         "正常的+",       "仅限旋转和个人电脑"},
        ...
        ['tsd_e']=         {"热关断挑战赛",        "容易的",       "只有T-Spin双打!"},
        ['tsd_h']=         {"热关断挑战赛",        "硬的",        "只有T-Spin双打!"},
        ['tsd_u']=         {"热关断挑战赛",        "终极的",       "只有T-Spin双打!"},
        ['backfire_n']=    {"适得其反",          "正常的",       "挡住回火的垃圾管道"},
        ['backfire_h']=    {"适得其反",          "硬的",        "挡住回火的垃圾管道"},
        ['backfire_l']=    {"适得其反",          "疯子",        "挡住回火的垃圾管道"},
        ['backfire_u']=    {"适得其反",          "终极的",       "挡住回火的垃圾管道"},
        ['sprintAtk']=     {"冲刺",            "100次攻击",     "发送100行!"},
        ['zen']=           {'Zen',            "200",        "没有时间限制的200线跑步"},
        ['ultra']=         {'Ultra',          "额外的",       "2分钟的得分进攻"},
    ...
    getTip={refuseCopy=true,
        ...
        "您可以使用键盘浏览菜单,但仅限于此屏幕",
        "您可以从统计数据页面打开保存目录",
        "在这个游戏中,你可以用29个米诺斯中的28个进行旋转;例外情况是O1",
        "您可以为每个四格拼板设置繁殖方向",
        "ZS JL T O I",
        {C.C,"也试试15拼图!"},
        {C.C,"还试试我的世界!"},
