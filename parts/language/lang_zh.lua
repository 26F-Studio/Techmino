...
return {
    ...
    cc_eventset_incompatible="CC不兼容规则包'$1'",
...
键盘：
        ...
        按 [Ctrl + C] 复制词条文本
        按 [$16] （上下文菜单键/应用程序键）打开词条中的链接（如果有）
...
手柄：
    ...
    getTip={refuseCopy=true,
        ...
        "40行世界纪录(1kf): 13.298s by fortissim2",
        "6236326236327175",
        "626in1",
        "6next 1hold！",
        "6next 6hold？！",
        ...
        "打铁.mp4",
        "大概还是有人会看tip的",
        "大家认为的俄罗斯方块很可能不是你以为的俄罗斯方块，有需要的时候可以适当提醒一下哦",
        "大满贯10连击消四全清！",
        "戴上耳机以获得最佳体验",
        "多年小游戏玩家表示痛恨拖时间的假加载",
        "多hold现代块又回来了！",
        ...
        "单手也能玩！", -- 可能是EK鲁比
        "不要大力拍打或滑动哦", -- Maimai
        "你的双手是为了你的一生服务的，而不是Techmino", -- osu
        "请勿大力敲打设备！敲坏了就没有Techmino玩了", -- phigros
        "少女祈祷中", -- Touhou
        "要盯着bug不放", -- Minecraft
        "你能做到。", -- Celeste
        "pps-0.01", -- Arcaea
        "你准备好了吗？", -- 最强大脑，2016.3
        "我曾经在极度愤怒的时候15秒消了40行", -- 网络，约2020
        "我一个滑铲就挖了个11renPC", -- 网络，约2020
        "希望极简率没事", -- 网络，约2020
        "做，做碌鸠啊做，打块先啦！", -- 饮茶哥，约2021
        "啊哈哈哈哈哈，T块来咯", -- 炊事员，约2021
        "不轻不重，手感真是好极了", -- 炊事员，约2021
        "他奶奶的，为什么转不进去", -- 炊事员，约2021
        "这打块，多是一件美事", -- 炊事员，约2021
        "你这块是金子做的还是垃圾行是金子做的", -- 刘华强，约2021
        "我们联合！", -- 一只大哈鱼，2021.5
        "啊我操SRS怎么这么坏", -- 网络，2024年底福岛核电站事故后
        "你起的楼顶上尖尖的", -- 阿诺，2024年底
        "哇多么好的游戏啊", -- Zun，2024年底
        "太好了是Allspin我们有救了", -- 泰坦陨落2，约2024
        "自定义模式偶遇2效机器人，拼尽全力无法战胜", -- 黑暗之魂3，约2024
        "不紧不慢不快不慢地起楼", -- Neuro，2025年初
        "IO打排位 输输赢赢输输赢 技术待提升", -- 俳句，2025年初
        "铁壳挖掘部 放下七块就挖开 续作也好玩", -- 俳句，2025年初
        "那一天的方块，堆叠起来", -- Lemon改编，2025.5.22
        "注意：已向此游戏发出一则版权侵犯通知。应用商店将审议此投诉并与发布此游戏的个人进行沟通，以及提供关于后续事宜的细节与信息。", -- Steam创意工坊DMCA风波，2025.8
        {C.Z,"1，2，",C.C,"⑨",C.Z,"！！！！！"}, -- Touhou
        {C.C,"<PURE ",C.P,"MEMORY>"}, -- Arcaea
        {C.H,"暂定段位:9"}, -- TGM
        {C.lY,"COOL！！"}, -- TGM
        {C.H,"REGRET!!"}, -- TGM
        {C.Y,"<φ> 10000"}, -- Phigros
        ...
        {C.Y,"O-spin！"},
        {C.lY,"Xspin",C.Z,"是啥"},
        {C.Z,"堆叠药水",C.H," 堆叠提升 (3:00)"}, -- Minecraft
        {C.Z,"挖掘药水",C.H," 挖掘提升 (8:00)"}, -- Minecraft
        {C.Z,"效率药水",C.H," 效率提升 (3:00)"}, -- Minecraft
        {C.Z,"协调药水",C.H," MD减少 II(1:30)"}, -- Minecraft
        {C.P,"T-spin!"},
        ...
        {C.O,"穿",C.lB,"梭",C.Z,"之力量"}, -- Portal 1片尾曲
        {C.lP,"Extraordinary!"}, -- Bejeweled 3
