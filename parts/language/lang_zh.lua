return{
	...
	getTip={refuseCopy=true,
		...
		"低帧率会降低游戏体验",
		"点击添加标题",
		"点击退出按钮会有极小概率发生一点神秘的事",
		"电脑游玩自带按键显示~",
		"对编程有真·兴趣推荐Lua,安装方便语法简单速度快",
		...
		{COLOR.cyan,"Osu!好玩!"},
		{COLOR.cyan,"Phigros好玩!"},
		{COLOR.cyan,"VVVVVV好玩!"},
		{COLOR.fire,"color.fire"},
		{COLOR.fire,"Cultris II也很好玩!"},
		{COLOR.fire,"Jstris也很好玩!"},
		{COLOR.fire,"Nullpomino也很好玩!"},
		{COLOR.fire,"Tetr.io也很好玩!"},
		{COLOR.fire,"Tetr.js也很好玩!"},
		{COLOR.fire,"Tetralegends也很好玩!"},
		...
		{COLOR.grey,"俄罗斯方块环游记也不错!"},
		{COLOR.grey,"感谢Phigros提供部分tips模板("},
		{COLOR.grey,"暂定段位:9"},
		{COLOR.grey,"REGRET!!"},
		{COLOR.lame,"color.lame"},
		{COLOR.lC,"26连T2来一个?"},
		{COLOR.lC,"Xspin",COLOR.W,"是啥"},
		...
		{COLOR.lGrey,"你有一个好"},
		{COLOR.lGrey,"STSD必死"},
		{COLOR.lGrey,"Techmino没有抽卡没有氪金,太良心了"},
