...
return{
    ...
    getTip={refuseCopy=true,
        ...
        "Let-The-Bass-Kick!",
        "STSD必死",
        "STSD如果暴毙可以吧一个J或者L转进去救场,救完以后还能做一个T2",
        ...
        "Techmino好玩!",
        "Techmino没有Lock Out判定, 只要锁定的方块不和下一块重叠就不算死",
        ...
        "Techmino在哪里下载",
        "Techmino怎么念啊",
        "Techmino中的一个模式是以东方Project里某个角色为主题的",
        "Z酱竟是我自己",
        "Z酱累了,Z酱不想更新",
        "Z酱是谁啊",
        "Z酱只是个写代码的,懂什么方块",
        "Z块等身抱枕来一个(x",
        "\"40L 没进1分钟建议别练那么多花里胡哨的, 先把堆叠和极简学好再说\"",
        "\"TechminOS\"",
        "c4w可不是在所有游戏里都很强哦",
        "c4w人竟是我自己",
        "c4w人竟在我身边",
        ...
        "git commit",
        "hello world",
        "iOS/iPadOS上键盘操控可能会有点问题, 先用触屏吧",
        "iOS/iPadOS什么时候才能有CI",
        "if a==true",
        "l-=-1",
        "macOS的文字显示高度有点问题,希望你用的不是mac(或者黑苹果)",
        "pps-0.01",
        "shutdown -h now",
        "sin(2α)=2sin(α)cos(α)",
        ...
        "不同旋转系统的手感很不一样, 建议选个适合的来玩 (当然别带到别的游戏里)",
        ...
        "健康小贴士:不要熬夜,真的会猝死",
        "健康小贴士:戴耳机玩音量不要调得太大, 戴的时间也不要太长, 不然真的会得听力障碍",
        "健康小贴士:玩游戏多眨眼,不然会干眼病",
        "建议使用双手游玩",
        "尽早学双旋吧,单旋没前途的",
        "经典块的水也很深,不要小看经典块玩家",
        ...
        "游戏字体里藏了一套Z块表情包",
        "有几个隐藏模式不能从地图进入,到处找找看吧",
        "有建议的话可以把信息反馈给作者~",
        "有疑问? 先看设置有没有你想要的",
        "右下角那个问号按钮是游戏说明书 (开了简洁模式当我没说)",
        "这不是休闲游戏…别怪关卡要求太高,多练吧",
        "这个菜单可以用纯键盘控制",
        "这个文本框里的内容是复制不了的, 想要看全部tip的建议去GitHub翻"
        ...
        {C.C,"噗哟噗哟好玩!"},
        {C.G,"GREEN"},
        {C.G,"Mac快捷键: Command+,=打开偏好设置 (当然在Techmino里没用"},
        {C.G,"Mac快捷键: Command+A=全选"},
        {C.G,"Mac快捷键: Command+D=复制一份"},
        {C.G,"Mac快捷键: Command+F=查找"},
        {C.G,"Mac快捷键: Command+Option+Delete=永久删除文件 (技术人员别杠)"},
        {C.G,"Mac快捷键: Command+Q=退出程序"},
        {C.G,"Mac快捷键: Command+Shift+Z=重做"},
        {C.G,"Mac快捷键: Command+Tab=切换窗口"},
        {C.G,"Mac快捷键: Command+W=关闭当前窗口"},
        {C.G,"Mac快捷键: Command+Z=撤销"},
        {C.G,"Mac快捷键: Command+[=返回上一个文件目录"},
        {C.G,"Win快捷键: Alt+F4=关闭当前窗口"},
        {C.G,"Win快捷键: Alt+Tab=切换窗口"},
        {C.G,"Win快捷键: Ctrl+A=全选"},
        {C.G,"Win快捷键: Ctrl+Alt+Z=查看所有qq消息"},
        {C.G,"Win快捷键: Ctrl+D=复制一份"},
        {C.G,"Win快捷键: Ctrl+F=查找"},
        {C.G,"Win快捷键: Ctrl+Tab=切换标签页"},
        {C.G,"Win快捷键: Ctrl+W=关闭当前标签页"},
        {C.G,"Win快捷键: Ctrl+鼠标滚轮=缩放"},
        {C.G,"Win快捷键: backspace=返回上一个文件目录"},
