...
return{
    ...
    getTip={refuseCopy=true,
        ...
        "时间碎片[005] V0.8.20加入O-Spin",
        "时间碎片[006] V0.8.5加入模式地图",
        "时间碎片[007] V0.8.19加入五连块",
        "时间碎片[008] V0.9.0加入自定义序列和模式",
        "时间碎片[009] V0.10.0加入录像回放",
        "时间碎片[010] V0.11.1加入小z词典",
        "时间碎片[011] V0.12.2加入mod系统",
        "时间碎片[012] V0.13.0联网对战测试",
        "时间碎片[013] V0.13.2加入任意场地高度",
        "时间碎片[014] V0.13.3加入控制台",
        "时间碎片[015] V0.14.4加入第一首不是用Beepbox制作的BGM",
        "时间碎片[016] V0.14.5加入第一首社区玩家自制BGM",
        "时间碎片[017] V0.15.5加入录像回放菜单",
        "时间碎片[018] V0.16.0应该是单次更新内容最多的(起码更新历史最长)",
        "时间碎片[019] V0.16.2加入打击垫样式的音效室",
        "时间碎片[020] V0.17.0加入手柄的摇杆和扳机支持",
        "使用固定堆叠方法达成20TSD难度很低",
        "试试用跳舞毯打块",
