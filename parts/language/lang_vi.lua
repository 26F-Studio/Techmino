...
return {
    ...
    getTip={refuseCopy=true,
        ...
        "ZS JL T O I",
        {C.C,"Hãy nhớ chơi thử 15puzzle!"},
        {C.C,"Hãy nhớ chơi thử Ballance!"},
        {C.C,"Hãy nhớ chơi thử Minecraft!"},
        {C.C,"Hãy nhớ chơi thử Minesweeper!"},
        {C.C,"Hãy nhớ chơi thử Orzmic!"},
        {C.C,"Hãy nhớ chơi thử osu!"},
        {C.C,"Hãy nhớ chơi thử Phigros!"},
        {C.C,"Hãy nhớ chơi thử Puyo Puyo!"},
        {C.C,"Hãy nhớ chơi thử Rubik’s cube!"},
        {C.C,"Hãy nhớ chơi thử Terraria!"},
        {C.C,"Hãy nhớ chơi thử Touhou Project!"},
        {C.C,"Hãy nhớ chơi thử VVVVVV!"},
        {C.C,"Hãy nhớ chơi thử World of goo!"},
        {C.C,"Hãy nhớ chơi thử Zuma!"},
