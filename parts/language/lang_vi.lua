...
C. Tay cầm chơi game (Gamepad):
    ...
    WidgetText={
        ...
        savedata={
            export="Xuất ra clipboard",
            import="Nhập từ clipboard",
            unlock="Tiến trình",
            data="Thống kê",
            setting="Cài đặt",
            vk="Bố cục cảm ứng",
    ...
    modes={
        ...
        ['master_g']=            {"Master",            "GRADED",         "Lấy hạng cao nhất có thể!"},
        ['master_ex']=           {"GrandMaster",       "EXTRA",          "Cũng là lấy hạng cao nhất có thể nhưng mà gắt hơn!"},
        ['master_instinct']=     {"Master",            "INSTINCT",       "Lấy hạng cao nhất có thể nhưng với gạch tàng hình!"},
