...
C. Tay cầm chơi game (Gamepad):
    ...
    modes={
        ...
        ['construct_invsg']=     {"Construct",         "INV. SG",        "Xây một đường thẳng theo hình dích dắc!"},
        ...
        ['tech_finesse_f']=      {"Kỹ thuật di chuyển","P L U S",        "Không được phép có lỗi di chuyển hoặc loại Xoá hàng thường!"},
        ['tech_finesse_lock']=   {"Kỹ thuật di chuyển","LOCK",           "Không được mắc lỗi di chuyển hoặc bạn không thể điều khiển gạch!"},
        ['tech_finesse_lock_f']= {"Kỹ thuật di chuyển","LOCK   P L U S", "Không được mắc lỗi di chuyển hoặc bạn không thể điều khiển gạch! Bạn cũng sẽ thua khi dùng kiểu xóa thường!"},
