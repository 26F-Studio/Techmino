...
return{
    ...
    {"Tetris Wiki",
        "tetris wiki",
        "help",
        "（英文）一个专注于创建俄罗斯方块相关内容的Wiki百科，由Myndzi在2015创办。年复一年，上千玩家贡献了一系列的官块和自制块的说明，游戏的隐藏机制，和提升游戏体验的教程",
        "https://tetris.wiki",
    },
    {"Tetris Wiki Fandom",
        "tetris wiki fandom",
    ...
    {"Tetris Gem",
        "宝石 tetris online official gem",
        "game",
        "tetris.com官网上的另一款俄罗斯方块，限时2分钟挖掘，有重力机制。有三种消除后可以获得不同功能的宝石方块。",
    },
    ...
    {"Techmino",
        "铁壳米诺 techmino tieke",
        "game",
        "简称Tech，win/android/linux/macOS/iOS方块，单机模式和各种设置都很齐全，联机正在逐渐开发中，输入延迟很小，手感很好",
    },
    {"Tetris 99",
        "吃鸡 t99 tetris99",
        "game",
        "简称T99，Nintendo Switch端方块，主玩99人混战的吃鸡模式，战术比重比较大，胜率不只由玩家在平时1V1时的水平决定。也有一些常用单机模式如马拉松等。",
    },
    {"Puyo Puyo Tetris",
        "噗哟方块 ppt puyopuyotetris",
        "game",
        "简称PPT，多平台方块（Steam PC版相对NS版手感和网络等都不太好），将Tetris和Puyo Puyo两个下落消除游戏放到一个游戏里，二者可以对战，联机单机模式都很多，很有趣",
    },
    {"Tetris Online",
    ...
    {"Tetris Blitz",
        "闪电战 tetris blitz ea",
        "game",
        "简称闪电战，EA代理的一款移动端方块，有重力机制，限时2分钟，游戏开始会掉下一堆小方块；持续消四会进入Frenzy模式（场地下方会不断冒出垃圾行，帮助玩家制造大连锁）。有非常多的道具\n\n已于2020年1月下架。",
    },
    {"Tetris (EA)",
        "tetris ea",
        "game",
        "EA代理的一款宇宙主题的移动端方块。有滑动操控和单点触控两种操作模式；除经典的马拉松外还有一个星系模式(地图挖掘)，有连锁机制，目标是在限定块数内消除所有地图块。\n\n已于2020年4月下架。"
    },
    {"Tetris Beat",
        "节奏 tetris beat n3twork",
        "game",
        "N3TWORK代理的一款移动端方块，有按钮、滑动和点击三种操控模式。除了马拉松模式外还有一个“节奏”模式，玩家根据音乐节奏落块可以得到额外分数奖励。特效比较花眼，操控手感不很好。",
    },
    {"Tetris (N3TWORK)",
        "Tetris n3twork",
        "game",
        "N3TWORK代理的一款移动端方块，有马拉松、限时打分和Royale（最多99人对战）模式。UI比较好看，但不支持自定义键位而且默认的按钮很小，手感不好。"
    },
    {"Touhoumino",
        "东方 车万 touhoumino chewan dongfang touhou",
        "game",
        "玩家自制win平台方块，东方主题，其实就是一个Nullpomino的自带资源包的改版，将东方Project元素结合到俄罗斯方块的游戏，好玩但是难度较大，适合有方块基础并且各项能力都较强的玩家游玩（不然都不知道自己怎么死的）",
    },
    {"Nanamino",
        "nanamino",
        "game",
        "块圈玩家自制win/android平台方块，正在开发中，有一个非常有趣的原创旋转系统",
    },
    {"Misamino",
        "回合制 misamino",
        "game",
    ...
    {"火拼俄罗斯",
        ...
        "game",
        "腾讯游戏大厅的方块，场地12列，打字的DAS和ARR，1 Next，无Hold，攻击途径只有消4打3、消3打2，垃圾行为国际象棋棋盘式，几乎不可能挖掘",
    },
    ...
    {"ASC+ RS",
        ...
        "term",
        "Techmino中对ASC的修改版本，添加了180度转的踢墙表",
    },
    {"BRS",
        "旋转系统 brs rotate",
        "term",
    ...
    {"B2B2B",
        "大满贯 b2b2b b3b",
        "term",
        "Back to Back to Back, B2B的加强版，缩写B3B，大量B2B后连续B2B会变成B2B2B（B3B），提供更强的攻击（仅Techmino中有）。",
    },
    {"Fin/Neo/Iso",
        "特殊 fin neo iso",
        "term",
    ...
    {"Hold",
        "暂存 交换 hold zancun",
        "term",
        "暂存功能，将手里的方块和Hold槽中的交换，一般不能连续使用。\n用来调整块序，更容易摆出你想要的形状。\n本游戏中有一个“物理hold”机制，开启后hold换出的方块会直接出现在当前方块所在的位置\n\n用不用hold各有好处，不用的话看到序列是什么就是什么，减少了思考量；并且减少了按键的种类，操作简单容易提升KPS，有些人的40行记录就是不用Hold打出的。用Hold可以灵活地调整序列，减少高重力等规则带来的难度，算力足够的情况下可以达成更复杂的目标，甚至反过来显著减少总按键数。",
    },
    {"Swap",
    ...
    {"His出块",
        "his出块 history",
        "term",
        "一种的出块方式，例如His4 Roll6 (h4r6)就是在随机生成新的Next的时候，随机一个跟最后4次生成的Next中有一样的，就重新随机，直到已经尝试6次或和那4个都不一样。\n本游戏的His序列模式中最大Roll次数为序列长度的一半（向上取整）\n\n是纯随机出块的一大改进，大大减小了连续出几个SZ（洪水）的概率。",
    },
    {"HisPool出块",
    ...
    {"Hypertap",
        "超连点 hypertap",
        "term",
        "快速震动手指，实现比长按更快速+灵活的高速单点移动，主要在经典块的高难度下（因为das不可调而且特别慢，高速下很容易md导致失败，此时手动连点就比自动移动更快）或者受特殊情况限制不适合用自动移动时使用。会使用这个技术的人被称为"Hypertapper",
    },
    {"TOP攻击表",
        "攻击表 top attack",
        "term",
    ...
    {"三旋",
        "三旋 sanxuan",
        "term",
        "指能够使用顺+逆时针+180º旋转三个旋转键的技术，任何方块放哪只需要旋转一次即可（Spin不算）\n但由于只有部分游戏有180º旋转所以改操作并不通用，而且对速度提升的效果不如从单旋转双旋显著，不追求极限速度的玩家可不学",
    },
    {"干旱",
        "干旱 drought ganhan",
        "term",
    ...
    {"Dr.Ocelot",
        "drocelot",
        "name",
        "国外方块游戏开发者，独自开发了Tetra Legends\n\n和Mine一起开发了Tetra Online，质量欠佳的半成品上架Steam后受到大量圈内人士批评（但都虚心采纳并修改）。",
    },
    {"Firestorm",
        "firestorm fst",
        "name",
    ...
    {"Circu1ation",
        "circu1ation",
        "name",
        "一流玩家，国内第一个40行sub20的玩家，TETR.IO段位X",
