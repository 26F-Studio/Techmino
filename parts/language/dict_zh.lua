...
return{
    ...
    {"方块形状",
        "xingzhuang xz shape",
        "term",
        "在标准的俄罗斯方块游戏中, 所有出方块都必须是四联块(由四个正方形在平面连接组成的图形). 小方块之间至少有一个边必须相连. 方块之间不能只有一个顶点相连或者根本不相连.\n在只允许旋转不允许对称的情况下, 四联块一共有七种, 根据它们各自的形状分别叫做 Z, S, J, L, T, O, I.",
    },
    {"方块颜色",
        "yanse color colour",
        "term",
        "在2000年TTC规定方块颜色以前, 方块颜色一直没有统一的标准.\n\n根据TTC的标准, 七种四联块的颜色分别如下:\nZ: 红色, S: 绿色, J: 蓝色, L: 橙色, T: 紫色, O: 黄色, I: 青色.\n\nTechmino默认使用TTC标准配色.",
    },
