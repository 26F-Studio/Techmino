...
return{
    ...
    {"Mew据点",
        "mew tieba forum reddit discord",
        "org",
    ...
    {"茶服",
        "茶服 teatube chafu study",
        "org",
        "TO-S的添加方法、说明等关于茶服的一切",
        "http://teatube.ltd/tos",
    },
    {"赞助1",
        "赞助 恰饭 support weixin vx zhifubao zfb zanzhu daqian qia lanqian",
        "org",
        "vx/zfb-控制台-support",
    },
    {"赞助2",
        "赞助 support aifadian afdian zanzhu daqian qia lanqian",
        "org",
        "Afdian",
        FNNS and"https://b23.tv/C2Cy1ph"or"https://afdian.net/@MrZ_26",
    },
    {"赞助3",
        "赞助 support zanzhu daqian qia",
        "org",
        "P\97\116\114\101\111\110",
        FNNS and"https://b23.tv/C2Cy1ph"or"https://www.p\97\116\114\101\111\110.com/techmino",
    },
    ...
    {"注[1]",
        "备注 notice",
        "game",
        "以下内容是为部分官方和同人较高人气方块游戏的简要介绍，我们不保证这些内容可以涵盖所有方块游戏。\n此外，本游戏的作者也对其中的本分游戏做出了一些评论。这些内容只代表了作者本人的个人观点，请不要用这些评论来判断游戏的好坏。为了区分这些内容，所有评论都用方括号括起来并与事实性内容分开。",
    },
    {"King of Stackers",
    ...
    {"Tetris.com",
        "网页 手机 tetris online official",
        "game",
        "网页游戏 | 单机 | 支持移动端\ntetris.com官网上的俄罗斯方块，只有马拉松一种模式，特色是支持基于鼠标指针位置的智能控制。",
    },
    {"Tetris Gems",
        "网页 宝石 tetris online official gems",
        "game",
        "网页游戏 | 单机\ntetris.com官网上的俄罗斯方块，限时1分钟挖掘，有重力机制。\n有三种消除后可以获得不同功能的宝石方块。",
    },
    {"Tetris Mind Bender",
        "网页 技能 tetris online official mindbender",
        "game",
    ...
    {"Texmaster",
        "txm texmaster",
        "game",
        "Windows | 单机\n简称Tex，包含TGM的所有模式，可以用来练习TGM，手感较好，但World规则不完全一样（如软降到底无锁延，踢墙表有细节不同等）。",
    },
    ...
    {"Nullpomino",
        "np nullpomino",
        "game",
        "Windows/macOS/Linux | 单机/多人\n简称NP，整个游戏自定义程度极高，几乎任何参数都可以自己设置，是一个专业级方块，不过UI风格比较老，需要全键盘操作，刚开始可能不习惯。\n[macOS Monteray貌似无法运行]",
    },
    {"Misamino",
        "回合制 misamino",
        "game",
    ...
    {"俄罗斯方块环游记",
        "环游记 腾讯 huanyouji tetris journey tencent",
        "game",
    ...
    {"Mishold",
        "误hold mh mishold",
        "term",
        "误hold，就是不小心按到Hold导致死亡或失去PC机会等。简称mMH。",
    },
    {"sub",
        "sub",
        "term",
    ...
    {"挖掘 Dig",
        ...
        "term",
        "指消除从场地底部进入的垃圾行（对手攻击打过来或者模式中自动生成）。也叫downstack。",
    },
    {"捐赠 Donate",
    ...
    {"C2W",
        "连击 ·c2w center2wide centre2wides",
        "term",
        "Center 2 Wide\n中间空2列，一种可能的连击打法（不常见）。",
    },
    {"C3W",
        "连击 ·c3w center3wide centre3wides",
        "term",
        "Center 3 Wide\n中间空3列，一种可能的连击打法（不常见）。",
    },
    {"C4W",
        "连击 ·c4w center4wide center4wides",
        "term",
