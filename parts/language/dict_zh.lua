...
return{
    ...
    {"20G",
        "高重力 瞬间下降 瞬降 20g",
        "term",
        "现代方块的最高下落速度，表观就是方块瞬间到底，不存在中间的下落过程，可能会让方块无法跨越壕沟/从山谷爬出。关于单位“G”的详细说明，请参考“下落速度”词条。",
    },
    {"死亡判定",
    ...
    {"下落速度",
        ...
        "term",
        "习惯上方块的下落速度一般用单位“G”来表示。G是格/帧的缩略（默认游戏以60帧运行，不是的话需要具体说明），故1/60G是每秒下落一格，1G是每帧1格（每秒60格）。按照这个解释，20G应该是每帧20格，但由于场地高度就是20，所以20G指的其实是“无限下落速度”，就算场地不止20格，“20G”也会让方块瞬间到底。关于20G的更多信息请参考“20G”词条。",
    },
    {"锁定延迟",
