...
return{
	...
	{"Tetra Online",
		"to tetraonline",
		"game",
		"PC方块打开Steam免费下载即玩，开发团队只有Dr.Ocelot和Mine两个人(都没有很多开发经验)，UI部分模仿PPT，手感故意设计为较慢，平时玩无延迟方块的玩家会很不习惯，音乐不错，攻击特效好看。",
		"http://tetralegends.app",
	},
	{"Jstris",
		"js jstris",
	...
	{"Dr.Ocelot",
		"drocelot",
		"name",
		"国外方块游戏开发者, 独自开发了Tetra Legends\n\n和Mine一起开发了Tetra Online，现在(2020年12月初)还处在开发阶段，上Steam后受到大量批评，由于之前的种种原因导致Dr.Ocelot已退出社区",
	},
	{"Firestorm",
		"firestorm fst",
		"name",
	...
	{"安樱奈莯",
		"naki anyingnaimu youling gui t210",
		"name",
