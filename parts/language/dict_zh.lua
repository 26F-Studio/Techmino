...
return{
    ...
    {"Jstris",
        "网页 手机 js jstris",
        "game",
        "网页游戏 | 单机/多人 | 支持移动端 | [服务器在国外可能卡]\n简称JS，有常用的科研向单机模式和自定义各种参数的功能，允许拖放固定尺寸的正方形虚拟按键。画面效果完全没有，一个动画都没有。",
    ...
    {"Techmino",
        "铁壳米诺 techmino tieke",
        "game",
        "跨平台 | 单机/多人\n简称Tech，使用LÖVE引擎开发的方块，单机模式和各种设置都很齐全，联机正在逐渐开发中。",
    },
    {"Falling Lightblock",
    ...
    {"Cambridge",
        "剑桥 cambridge",
        "game",
        "跨平台  | 单机\n使用LÖVE引擎开发的一款方块游戏，致力于创建一个轻松高度自定义新模式的方块平台。最初由Joe Zeng开发，于2020.10.8日的0.1.5版开始Milla接管了开发。 — Tetris Wiki.",
    },
    {"Nanamino",
        "nanamino",
        "game",
    ...
    {"JJ块",
        "手机 jj gougou",
        "game",
        "Android | 单机/多人\nJJ棋牌平台下一个休闲游戏，安卓百度“JJ比赛”官网下载平台后可以找到（找不到的原因是iOS系统或者没在官网下载或者被限制不可直接访问游戏）。竖屏，输入延迟很小，可自定义DAS/ARR/20G软降，简单自定义键位，无Hold，没有B2B，无攻击缓冲不可抵消，每次攻击上限为4，连击较强，其他同现代方块。",
    },
    {"火拼俄罗斯",
