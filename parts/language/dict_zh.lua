...
return{
    ...
    {"Fumen 方块谱",
        "fumen",
        "help",
        "（日文）一个方块铺，可以用于分享定式，PC解法等，用处很多。",
        "http://fumen.zui.jp"
    },
    {"Fumen 手机版",
        "fumenformobile fm",
        "help",
        "（英文）一个方块铺，对触屏控制的适配较好。可以用于分享定式，PC解法等，用处很多。",
    ...
    {"TTT",
        ...
        "game",
        "全称Tetris Trainer Très-Bien。作者为こな。现代方块特殊操作手把手教程（只能键盘操作，无Hold）\n\t推荐能纯消四完成40L挑战的人学习\n\t内含T-spin、极简、SRS、部分对战定式介绍等教程\n注：提供的链接是翻译后挂在茶服的版本",
    ...
    {"Jstris",
        "网页 手机",
        "game",
        "网页游戏 | 单机/多人 | 支持移动端 | [服务器在国外可能卡]\n简称JS，有常用的科研向单机模式和自定义各种参数的功能，允许拖放固定尺寸的正方形虚拟按键，没有任何动画效果。有21行的块可重叠，22行以上的块会消失的特性。",
    ...
    {"*L PC",
        "2lpc 4lpc 6lpc 8lpc 10lpc 12lpc 14lpc",
        "term",
        "可以理解为消除*行的PC，常见的有2LPC 4LPC 6LPC 8LPC 10LPC 12LPC 14LPC。",
    },
    ...
    {"MPH模式",
        "",
        "term",
        "一个游戏模式：\nMemoryless，Previewless，Holdless\n块序纯随机+无Next+无Hold完成40L，一个非常考验玩家反应速度的模式。",
    },
    {"输入延迟",
        "input delay yanchi",
        "term",
    ...
    {"Cold Clear",
        ...
        "term",
        "一个AI的名字（就跟AlphaGo一样）\n由MinusKelvin开发，其本身是为PPT开发。在本游戏中经过调整后支持all-spin和TRS旋转系统",
    },
    {"ZZZbot",
    ...
    {"ILSZ(100%)",
        "1stpc",
        "setup",
        "ILSZ Perfect Clear Setup，一个100%的四块地基。这个四块地基用到了I块、L块、S块和Z块。更多信息见テトリス堂",
        "https://shiwehi.com/tetris/template/ilszpc.php"
        },
    {"DPC",
        "DPC",
        "setup",
    ...
    {"1st pc",
        "pcloop",
        "pattern",
        "包数为7+3的PC。\n常见的地基有全清开局（Perfect Clear Opener）、六巧板（Grace System）、ILSZ(100%)和ILZO-1(99.52%)。\n链接会跳转到 ILZO-1",
        "https://shiwehi.com/tetris/template/ilzo1pc.php"
    },
    {"2nd pc",
        "pcloop",
        "pattern",
        "包数为4+6的PC。\n更多信息可见テトリス堂。",
        "https://shiwehi.com/tetris/template/2ndpc.php"
    },
    {"3rd pc",
        "pcloop",
        "pattern",
        "包数为1+7+2的PC。\n更多信息可见テトリス堂。",
        "https://shiwehi.com/tetris/template/3rdpc.php"
    },
    {"4th pc",
        "pcloop",
        "pattern",
        "包数为5+5的PC。\n更多信息可见テトリス堂。",
        "https://shiwehi.com/tetris/template/4thpc.php"
    },
    {"5th pc",
        "pcloop",
        "pattern",
    ...
    {"6th pc",
        ...
        "pattern",
        "包数为6+4的PC。\n更多信息可见four.lol。",
        "https://four.lol/perfect-clears/6th"
    },
    {"7th pc",
        "pcloop",
        "pattern",
        "包数为3+7的PC，做完7th pc后可回到1st pc\n更多信息可见テトリス堂。",
        "https://shiwehi.com/tetris/template/7thpc.php"
    },
    {"2L PC",
        "pcloop",
        "pattern",
        "可让包数往后推进四个（例:3rd->7th）的PC。",
    },
    {"绯红之王",
