...
return{
    ...
    {"Ascension",
        "网页 asc ascension",
        "game",
        "简称asc，全平台网页版单机方块点击即玩（第一次加载可能很慢），使用自己的ASC旋转系统，有不少单机模式（本游戏的堆积模式就来自asc），对战模式目前处在测试阶段（2021.8.20）",
    ...
    {"Tetris Gem",
        ...
        "game",
        "tetris.com官网上的另一款俄罗斯方块，限时2分钟挖掘，有重力机制。三种消除后可以获得不同功能的宝石方块。",
    },
    ...
    {"Texmaster",
        "txm texmaster",
        "game",
        "简称Tex，win平台方块，包含TGM的所有模式，可以用来练习TGM，手感比真版较好，不足的是world规则不完全一样（如软降到底无锁延，踢墙表有细节不同等）",
    },
    ...
    {"Techmino",
        "铁壳米诺 techmino tieke",
        "game",
        "简称Tech，win/android/linux/macOS方块，单机模式和各种设置都很齐全，联机正在逐渐开发中，输入延迟很小，手感很好",
    },
    {"Tetris99",
        "吃鸡 t99 tetris99",
        "game",
    ...
    {"Tetris Online",
        ...
        "game",
        "简称TO[服务器名首字母]，win平台方块，主要用来6人内对战/单挑/刷每日40L榜/挖掘模式/打机器人。支持自定义das/arr但都不能到0，有一点输入延迟但问题不大，是新人入块圈不错的选择。\n\n现在还开着的服务器有：\n\tTO-P（波兰服，服务器在波兰，可能会卡顿）\n\tTO-S（研究服，研究群群友自己开的服，很稳定，需要进群注册）\n\tTO-X（千雪服，VUP星月千雪于20年9月开的服，还处于实验阶段）",
    },
    {"Tetra Online",
        "to tetraonline",
        "game",
    ...
    {"Tetris Effect",
        ...
        "game",
        "简称TE（C），win/ps4/xbox平台方块，特效方块游戏，只有单机模式，手感不算太好，想看特效的可以一试，只是去玩方块的不是很建议\n有一个拓展版本Tetris Effect：Connected增加了联网对战，包含普通对战，zone对战，经典对战和boss战四个模式",
    },
    {"Cultris II",
        "文艺方块 c2 cultris2 cultrisii",
        "game",
        "简称C2，win/linux/macOS平台方块，设计基于经典规则出发，但支持自定义das/arr，对战的主要玩法是基于时间的连击，考验玩家速度/wide打法/挖掘",
    },
    {"Nullpomino",
        "np nullpomino",
        "game",
        "简称NP，win平台方块，整个游戏自定义程度极高，几乎任何参数都可以自己设置，是一个专业级方块，不太适合新人上手，连菜单都不太好搞清楚",
    },
    {"俄罗斯方块环游记",
    ...
    {"堆叠",
        "堆叠 duidie stack",
        "term",
        "将方块无缝隙地堆起来，需要玩家有预读next的能力，可以通过不使用hold并且用十个消四完成40行模式进行练习。\n这项能力从入坑到封神都是非常重要的。",
    },
    {"双旋",
        "双旋 shuangxuan",
        "term",
