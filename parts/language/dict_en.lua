...
FNNS and     {"Support 3",
    ...
    {"Tetris (N3TWORK)",
        ...
        "game",
        "iOS/Android | Singleplayer\nA Tetris game, formerly developed by N3TWORK; but now development rights have been in the hands of PlayStudio from the end of November 2021. It has a super 3-minute mode, a marathon mode, a 100-player Royale mode, and an Adventure mode (a mode in which you complete an objective in a limited number of moves).\n\nNote: from November or December 2022 onwards, all newly created accounts only have Marathon mode and Adventure mode. Also, Quick Play and Royale modes will not be available on these new accounts\n[The user interface is great, but its controls are not very good.]",
    },
    {"Tetris Beat",
        "n3twork rhythm",
        "game",
