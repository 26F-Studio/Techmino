...
return{
    ...
    {"Touhoumino",
        "touhoumino",
        "game",
        "*Windows | Single-player*\nA Nullpomino mod withel elements from Touhou Project. It is fun to play but difficult. Recommended for players with at least half-decent skills otherwise you don't even know how you die",
    },
    {"Nanamino",
        "nanamino",
        "game",
