...
return{
    ...
    {"Tetris OL Servers",
        ...
        "org",
        "Google “Tetris Online Poland” for the Poland server.\nClick on the globe icon for Tetris Online Study server information.",
    ...
    {"Jstris",
        "js jstris",
        "game",
        "Browser Game | Singleplayer/Multiplayer | Mobile Support\nOr JS for short. It has some single-player modes with multiple customizable parameters, Adjustable virtual key layouts for mobile, but it doesn’t have any animation. ",
    ...
    {"Death ARE",
        "die delay",
        "term",
        "(Techmino exclusive) When an existing block blocks the spawn location of the next piece in the field, a delay will be added to the spawn ARE, referred to as the death ARE. This mechanism can be used along with IHS and IRS to prevent death. \nOriginal idea by NOT_A_ROBOT.",
    },
    {"Finesse",
        "finesse",
        "term",
    ...
    {"Handling",
        "feel handling",
        "term",
        "Several main factors affect handling:\n(1) Input delay, which is affected by device configuration or condition. Restart the game or change your device to fix it.\n(2) Program stability, program design (or implementation) is not good, cause lagging too much. It can be alleviated by lowering the effect setting.\n(3) Designed on purpose. Just adapt to it.\n(4) Improper parameter setting. Change the settings.\n(5) Improper play posture. It’s not convenient to use force. Change your posture.\n(6) Not used to the operation after changing the key position or changing the device. Get used to it or change the settings.\n(7) Muscle fatigue, response, and coordination ability decrease. Have some rest and come back later or in a few days.",
    },
    {"DAS (simple)",
