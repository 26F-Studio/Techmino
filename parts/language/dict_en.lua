...
FNNS and     {"Support 3",
    ...
    {"Tetris (N3TWORK)",
        ...
        "game",
        "iOS/Android | Singleplayer\nA Tetris game, formerly developed by N3TWORK; has now ceded the copyright to PlayStudio from the end of November 2021. It has a 3-minute ultra mode, a marathon mode, a 100-player Royale mode and Adventure mode.\n\nNote: from November or December 2022 and later, all newly created accounts only have Marathon mode and Adventure mode. In addition, Quick Play and Royale modes will not appear on these new accounts\n[The UI is great, but its controls are not so good.]",
    },
    {"Tetris Beat",
        "n3twork rhythm",
        "game",
