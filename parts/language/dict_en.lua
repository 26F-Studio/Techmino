...
return{
    ...
    {"Tetrominos' Shapes",
        ...
        "term",
        "In standard Tetris games, all the blocks are tetrominoes (spelt as \"Tetrimino\" in official games), i.e. Blocks that are linked by four minoes side-by-side. Minoes cannot be joined only at the corner (pseudo-tetromino) or not be connected at all (quasi-tetromino).\nThere are seven kinds of tetrominoes in total when considering translations and rotations (but not reflection). These tetrominoes are named by the letter in the alphabet that they resemble. They are Z, S, J, L, T, O, and I.",
    },
    {"Tetrominos' Colors",
        "colour hue tint",
        "term",
        "Before The Tetris Company published their guidelines on Tetris, the colours of the tetrominoes vary from game to game.\nAccording to the Guideline, the colours of the tetrominoes are\nZ – red, S – green, J – blue, L – orange, T – purple, O – yellow, and I – cyan.\n\nTechmino uses the guideline published by The Tetris Company for the colours of the tetrominoes.",
    },
    {"Single",
        "single",
        "term",
