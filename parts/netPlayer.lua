...
function NETPLY.add(d)
    local p={
        ...
        isBot=d.isBot==true,-- Bot marker so netBattle.load can route bots
        -- through newAIPlayer instead of newRemotePlayer (which
        -- would call _loadRemoteEnv with the bot's empty config
        -- and emit "Bad conf from Bot N#bot-…" warnings).
        place=1e99,
        stat=false,
    }
