...
scene.widgetList={
	...
	WIDGET.newButton{name="resetUnlock",	x=340,y=460,w=280,h=100,color="red",
		code=function()
			...
			TEXT.show("Your ranks have been reset.",640,300,60,"stretch",.4)
			LOG.print("This will take effect after restarting the game.","message")
			LOG.print("Get a rank to undo data deletion.","message")
		end,
		hide=HIDE},
	WIDGET.newButton{name="resetRecord",	x=640,y=460,w=280,h=100,color="red",
		code=function()
			...
			TEXT.show("Your records have been removed.",640,300,60,"stretch",.4)
			LOG.print("Get ranked in a record list to get that list back.","message")
		end,
		hide=HIDE},
	WIDGET.newButton{name="resetData",		x=940,y=460,w=280,h=100,color="red",
		code=function()
			...
			SFX.play("finesseError_long")
			TEXT.show("Your game data has been reset.",640,300,60,"stretch",.4)
			LOG.print("This will take effect after restarting the game.","message")
			LOG.print("Finish at least one game to undo data deletion.","message")
		end,
		hide=HIDE},
