...
scene.widgetList={
    ...
    WIDGET.newSlider{name='vib',      x=300, y=590,w=420,lim=220,color='lN',disp=SETval('vib'),axis={0,20,1},code=function(v) SETTING.vib=v end,change=function() VIB(SETTING.vib + 1, vibType) end},
