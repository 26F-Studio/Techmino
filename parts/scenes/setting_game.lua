...
scene.widgetList={
	...
	WIDGET.newSwitch{name="dataSaving",	x=1060,	y=490,	font=30,disp=SETval("dataSaving"),	code=function()SETTING.dataSaving=not SETTING.dataSaving if not SETTING.dataSaving then USERS.forceFreshAvatar()end end},
	WIDGET.newSwitch{name="simpMode",	x=1060,	y=550,	font=30,disp=SETval("simpMode"),
		code=function()
