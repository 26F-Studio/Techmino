...
WIDGET.init("main",{
	...
	WIDGET.newButton({name="custom",	x=590,y=220,w=200,h=140,color="lBlue",	font=40,code=WIDGET.lnk.goScene("customGame"),hide=function()return not RANKS.marathon_normal end}),
	...
	WIDGET.newButton({name="lang",		x=150,y=515,w=200,h=90,color="lYellow",	font=40,code=WIDGET.lnk.goScene("lang")}),
	WIDGET.newButton({name="help",		x=370,y=515,w=200,h=90,color="dGreen",	font=40,code=WIDGET.lnk.goScene("help")}),
