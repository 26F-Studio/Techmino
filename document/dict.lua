return{
	...
	},
	{
		...
		"das",
		"term",
		"Delay-auto-shift,自动移动延迟,指从<按下移动键时动了一格>到<开始自动移动>之间的时间\nARR则<每次自动移动>之间的时间\n单位都是 帧,也就是1/60秒\n新人推荐用das=8~10,arr=1~2\n有一定水平想提速用das=4~6,arr=0~1",
	},
	{
		"ARR",
		"arr",
