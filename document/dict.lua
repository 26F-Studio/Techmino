return{
	...
	{"LPM",
		"lpm sudu",
		"term",
		"Line per Minute，行每分，体现玩家下块速度。\n注:TOP中的lpm是用pps换算的，不是字面意思",
	},
	{"PPS",
		"pps sudu",
		"term",
	...
	{"BPM",
		"bpm sudu",
		"term",
		"Block per Minute，块每分，体现玩家下块速度\n别问为什么不是PPM，问就是不知道",
	},
	{"APM",
		"apm gongji",
		"term",
		"Attack per Minute，攻击每分，即玩家每分钟打出的垃圾行数。\n一定程度体现玩家攻击力",
	},
	{"KPM",
		"kpm sudu",
		"term",
	...
	{"PC",
		...
		"term",
		"Perfect Clear(也叫All Clear，全消，或全清)，消除场地上所有的方块。",
	},
	{"HPC",
	...
	{"S1W",
		"s1w side2wide",
		"term",
		"Side 1 Wide，旁边空1列，是传统方块游戏里常见的消四打法。\n在现代方块对战中新手可以使用，短时间能打出大量攻击，但在高手场出场率不高，因为效率低，容易被对面一波打死，故只在极少数情况合适的时候用。",
	},
	{"S2W",
		"s2w side2wide",
		"term",
		"Side 2 Wide，旁边空2列，是常见的连击打法。\n难度很低，现代块对战中新手可以使用，结合hold可以很轻松地打出大连击。高手场使用不多，因为准备时间太长，会被对面提前打进垃圾行，导致连击数减少，效率也没有特别高，故一套打完也不一定能杀人。",
	},
	{"S3W",
		"s3w side2wide",
		"term",
		"Side 3 Wide，旁边空3列，不如2w常见的连击打法。能打出的连击数比2w多，但是难度偏大很容易断连。",
	},
	{"S4W",
		"s4w side4wide",
		"term",
		"Side 4 Wide，旁边空4列，一种连击打法，能打出很高的连击，并且准备时间比别的wide打法短，故动作快的话可以抢在对手打进垃圾之前堆很高然后打出超大连击。\n(因为可能会被提前打死，风险挺大，所以没有c4w那么不平衡)",
	},
	{"C1W",
		"c1w center1wide",
		"term",
		"Center 1 Wide，中间空1列，一种实战里消4同时辅助打TSD的打法，需要玩家理解<平衡法>，熟练之后可以轻松消四+T2输出，难度也不是特别大。",
	},
	{"C2W",
		"c2w center2wide",
		"term",
		"Center 2 Wide，中间空2列，一种连击打法",
	},
	{"C3W",
		"c3w center3wide",
		"term",
		"Center 3 Wide，中间空3列，一种连击打法",
	},
	{"C4W",
		"c4w center4wide",
		"term",
		"Center 4 Wide，中间空四列，一种连击打法，能打出很高的连击，利用了大多数专业对战方块游戏的死亡判定机制，可以放心堆高不担心被顶死，然后开始连击。是一种利用游戏机制的不平衡策略(尤其在开局时)，观赏性不是很强还可以以弱胜强，成本太低所以成为了部分游戏中约定的类似 禁招 的东西，请在了解情况后再使用，不然可能会被别人骂。\n\n本游戏里做了平衡，c4w强度没有别的游戏高，而且打的是电脑所以放心用~",
	},
	...
	{"TKI",
		"tki",
		"term",
		"TKI开局，有两种解释，一个是TSD开局，另一个是Cspin开局。\n详细请到HD wiki查询",
	},
	{"God Spin",
		"god",
		"term",
		"God Spin，是windkey发明的一个观赏性很强但实战没啥用的炫酷特殊T2+T3开局定式。\n详细请到HD wiki查询",
	},
	...
	{"bag7",
		"bag7bag",
		"term",
		"bag7，一种现代方块的出块方式，开局起每7个块是7种形状各出现一次\n\n例如:\nZSJLTOI OTSLZIJ LTISZOJ",
	},
	{"His出块",
		"history",
		"term",
	...
	{"Cold Clear",
		"cc coldclear",
		"term",
		"一个ai的名字(就跟alphaGo一样)，本身是为ppt开发，故在本游戏中使用效果欠佳，版本也较旧",
	},
	{"ZZZbot",
		"zzzbot",
		"term",
		"一个ai的名字(就跟alphaGo一样)，由研究群群友奏之章开发，在各游戏表现都很不错",
	},
